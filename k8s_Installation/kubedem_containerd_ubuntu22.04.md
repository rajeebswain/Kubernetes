...
[Link For Kubernetes Instlation for Kubeadm](https://github.com/kunchalavikram1427/YouTube_Series/blob/main/Kubernetes/ClusterSetup/Kubernetes_on_aws_with_containerd.md)
---
...
$ sudo chown $(id -u):$(id -g) $HOME/.kube/config
```
[Link For Kubernetes Instlatio for Kubeadm](https://github.com/kunchalavikram1427/YouTube_Series/blob/main/Kubernetes/ClusterSetup/Kubernetes_on_aws_with_containerd.md)
